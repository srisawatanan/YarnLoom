...
#[derive(Debug)]
pub struct YarnLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YarnLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YarnLoom processing");
    
    let mut processor = YarnLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YarnLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YarnLoomProcessor::new(false);
